...
import feauture03 from '../../assets/images/rrpps/feauture03.png';
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 lg:gap-8 items-stretch">
                        <div className="lg:col-span-5" style={{
                            ...
                            <h2 className="mb-6" style={{
                                ...
                                Más fácil para ti, más control para tu club
                            </h2>
                            <p className="mb-5" style={{
                                ...
                                Con Klubit los managers marcan objetivos y cupos, y tú puedes centrarte en vender y en tu comunidad.
                            </p>
                            <ul className="space-y-3" style={{ listStyle: 'none', padding: 0 }}>
                                <li className="flex items-start" style={{
                                    ...
                                    <span>Asignación clara de entradas y consumiciones.</span>
                                </li>
                                <li className="flex items-start" style={{
                                    color: '#ECF0F5',
                                    fontFamily: '"Helvetica Now Display"',
                                    ...
                                    <Check style={{ marginRight: '12px', color: '#E5FF88', minWidth: '24px', marginTop: '2px' }} size={24} />
                                    <span>Transparencia en objetivos y resultados.</span>
                                </li>
                                <li className="flex items-start" style={{
                                    color: '#ECF0F5',
                                    fontFamily: '"Helvetica Now Display"',
                                    ...
                                    <Check style={{ marginRight: '12px', color: '#E5FF88', minWidth: '24px', marginTop: '2px' }} size={24} />
                                    <span>Más orden para el club, más ingresos para ti.</span>
                                </li>
                            </ul>
                        </div>
                        <motion.div
