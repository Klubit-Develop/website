...
import feauture04 from '../../assets/images/brands/feauture04.png';
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 lg:gap-8 items-stretch">
                        ...
                        <div className="lg:col-span-5" style={{
                            ...
                            <h2 className="mb-6" style={{
                                ...
                                Gestiona campañas como un canal publicitario más
                            </h2>
                            <p className="mb-5" style={{
                                ...
                                Trata Klubit como un soporte adicional en tu mix de medios.
                            </p>
                            <ul className="space-y-3" style={{ listStyle: 'none', padding: 0 }}>
                                <li className="flex items-start" style={{
                                    ...
                                    <span>Activa campañas con partners de publicidad programática.</span>
                                </li>
                                <li className="flex items-start" style={{
                                    color: '#ECF0F5',
                                    fontFamily: '"Helvetica Now Display"',
                                    ...
                                    <Check style={{ marginRight: '12px', color: '#E5FF88', minWidth: '24px', marginTop: '2px' }} size={24} />
                                    <span>Gestiona y ajusta tus campañas desde un solo panel.</span>
                                </li>
                                <li className="flex items-start" style={{
                                    color: '#ECF0F5',
                                    fontFamily: '"Helvetica Now Display"',
                                    ...
                                    <Check style={{ marginRight: '12px', color: '#E5FF88', minWidth: '24px', marginTop: '2px' }} size={24} />
                                    <span>Combina activaciones in-app con tu estrategia de marca.</span>
                                </li>
                            </ul>
                        </div>
                    </div>
