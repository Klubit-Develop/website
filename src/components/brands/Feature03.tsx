...
import feauture03 from '../../assets/images/brands/feauture03.png';
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 lg:gap-8 items-stretch">
                        <div className="lg:col-span-5" style={{
                            ...
                            <h2 className="mb-6" style={{
                                ...
                                Activa promociones directamente en la app
                            </h2>
                            <p className="mb-5" style={{
                                ...
                                Tu marca integrada en la experiencia de los clientes, sin soportes externos.
                            </p>
                            <ul className="space-y-3" style={{ listStyle: 'none', padding: 0 }}>
                                <li className="flex items-start" style={{
                                    ...
                                    <span>Envía descuentos, beneficios o experiencias exclusivas en la app.</span>
                                </li>
                                <li className="flex items-start" style={{
                                    color: '#ECF0F5',
                                    fontFamily: '"Helvetica Now Display"',
                                    ...
                                    <Check style={{ marginRight: '12px', color: '#E5FF88', minWidth: '24px', marginTop: '2px' }} size={24} />
                                    <span>Conecta tus activaciones con reservas, compras y consumiciones.</span>
                                </li>
                                <li className="flex items-start" style={{
                                    color: '#ECF0F5',
                                    fontFamily: '"Helvetica Now Display"',
                                    ...
                                    <Check style={{ marginRight: '12px', color: '#E5FF88', minWidth: '24px', marginTop: '2px' }} size={24} />
                                    <span>Fideliza con recompensas personalizadas que generan recurrencia.</span>
                                </li>
                            </ul>
                        </div>
                        <motion.div
