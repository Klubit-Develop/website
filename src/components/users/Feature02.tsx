...
import feauture02 from '../../assets/images/users/feauture02.png';
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 lg:gap-8 items-stretch">
                        ...
                        <div className="lg:col-span-5" style={{
                            ...
                            <h2 className="mb-6" style={{
                                ...
                                Acumula puntos y disfruta de beneficios exclusivos
                            </h2>
                            <p className="mb-5" style={{
                                ...
                                Cada consumo cuenta y se transforma en ventajas para ti.
                            </p>
                            <ul className="space-y-3" style={{ listStyle: 'none', padding: 0 }}>
                                <li className="flex items-start" style={{
                                    ...
                                    <span>Gana Kpoints con cada entrada, reserva o pago.</span>
                                </li>
                                <li className="flex items-start" style={{
                                    color: '#ECF0F5',
                                    fontFamily: '"Helvetica Now Display"',
                                    ...
                                    <Check style={{ marginRight: '12px', color: '#E5FF88', minWidth: '24px', marginTop: '2px' }} size={24} />
                                    <span>Accede a descuentos, consumiciones extra o accesos VIP.</span>
                                </li>
                                <li className="flex items-start" style={{
                                    color: '#ECF0F5',
                                    fontFamily: '"Helvetica Now Display"',
                                    ...
                                    <Check style={{ marginRight: '12px', color: '#E5FF88', minWidth: '24px', marginTop: '2px' }} size={24} />
                                    <span>Disfruta de experiencias exclusivas como cliente habitual.</span>
                                </li>
                            </ul>
                        </div>
                    </div>
