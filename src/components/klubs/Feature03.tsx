...
import feauture03 from '../../assets/images/klubs/feauture03.jpg';
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 lg:gap-8 items-stretch">
                        <div className="lg:col-span-5" style={{
                            ...
                            <h2 className="mb-6" style={{
                                ...
                                Coordina y potencia el trabajo de tus RRPPs
                            </h2>
                            <p className="mb-5" style={{
                                ...
                                Da a tu equipo las herramientas que necesitan para atraer más clientes, medir su gestión y vincularse al club.
                            </p>
                            <ul className="space-y-3" style={{ listStyle: 'none', padding: 0 }}>
                                <li className="flex items-start" style={{
                                    ...
                                    <span>Define cupos y condiciones para cada RRPP.</span>
                                </li>
                                <li className="flex items-start" style={{
                                    color: '#ECF0F5',
                                    fontFamily: '"Helvetica Now Display"',
                                    ...
                                    <Check style={{ marginRight: '12px', color: '#E5FF88', minWidth: '24px', marginTop: '2px' }} size={24} />
                                    <span>Supervisa reservas y consumos en tiempo real con nuestras estadísticas.</span>
                                </li>
                                <li className="flex items-start" style={{
                                    color: '#ECF0F5',
                                    fontFamily: '"Helvetica Now Display"',
                                    ...
                                    <Check style={{ marginRight: '12px', color: '#E5FF88', minWidth: '24px', marginTop: '2px' }} size={24} />
                                    <span>Aumenta la eficiencia del equipo y la rentabilidad del club.</span>
                                </li>
                            </ul>
                        </div>
                        <motion.div
