    ...
    return (
        <footer style={{
            ...
            <div className="w-full max-w-7xl mx-auto">
                ...
                <div 
                    className="border-t flex flex-col md:flex-row justify-between items-center" 
                    style={{ 
                        borderColor: '#303030',
                        paddingTop: '32px',
                        paddingBottom: '32px',
                ...
                >
                    <p className="mb-4 md:mb-0" style={copyrightStyle}>
                        {t('footer.copyright')}
                    </p>
                ...
                <div className="border-t pt-8 flex flex-col md:flex-row items-center gap-6" style={{ borderColor: '#303030' }}>
