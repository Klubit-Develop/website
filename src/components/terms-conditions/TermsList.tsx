        ...
        const fetchTerms = async () => {
            try {
                ...
                const response = await fetch(
                    `https://api.klubit.io/v1/terms-and-conditions?language=${apiLanguage}`
                );
                ...
                if (apiData.data && apiData.data.termsAndConditions) {
                    setSections(apiData.data.termsAndConditions.sections);
                } else {
