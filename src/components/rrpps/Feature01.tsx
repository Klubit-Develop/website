...
import feauture01 from '../../assets/images/rrpps/feauture01.png';
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 lg:gap-8 items-stretch">
                        <div className="lg:col-span-5" style={{
                            ...
                            <p className="mb-5" style={{
                                ...
                                Convierte tu esfuerzo en ingresos reales y demuestra el valor que aportas a tu club.
                            </p>
                            <ul className="space-y-3" style={{ listStyle: 'none', padding: 0 }}>
                                <li className="flex items-start" style={{
                                    ...
                                    <span>Consulta tus métricas en tiempo real.</span>
                                </li>
                                <li className="flex items-start" style={{
                                    color: '#ECF0F5',
                                    fontFamily: '"Helvetica Now Display"',
                                    ...
                                    <Check style={{ marginRight: '12px', color: '#E5FF88', minWidth: '24px', marginTop: '2px' }} size={24} />
                                    <span>Identifica a tus clientes más activos.</span>
                                </li>
                                <li className="flex items-start" style={{
                                    color: '#ECF0F5',
                                    fontFamily: '"Helvetica Now Display"',
                                    ...
                                    <Check style={{ marginRight: '12px', color: '#E5FF88', minWidth: '24px', marginTop: '2px' }} size={24} />
                                    <span>Mejora tus comisiones con datos claros y transparentes.</span>
                                </li>
                            </ul>
                        </div>
                        <motion.div
