...
import feauture01 from '../../assets/images/users/feauture01.png';
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 lg:gap-8 items-stretch">
                        <div className="lg:col-span-5" style={{
                            ...
                            <h2 className="mb-6" style={{
                                ...
                                Reserva y paga de forma rápida y segura
                            </h2>
                            <p className="mb-5" style={{
                                ...
                                Olvídate de colas, entradas perdidas o pagos complicados.
                            </p>
                            <ul className="space-y-3" style={{ listStyle: 'none', padding: 0 }}>
                                <li className="flex items-start" style={{
                                    ...
                                    <span>Compra entradas y haz reservas desde la app en segundos.</span>
                                </li>
                                <li className="flex items-start" style={{
                                    color: '#ECF0F5',
                                    fontFamily: '"Helvetica Now Display"',
                                    ...
                                    <Check style={{ marginRight: '12px', color: '#E5FF88', minWidth: '24px', marginTop: '2px' }} size={24} />
                                    <span>Guarda todos tus accesos y consumiciones en tu wallet digital.</span>
                                </li>
                                <li className="flex items-start" style={{
                                    color: '#ECF0F5',
                                    fontFamily: '"Helvetica Now Display"',
                                    ...
                                    <Check style={{ marginRight: '12px', color: '#E5FF88', minWidth: '24px', marginTop: '2px' }} size={24} />
                                    <span>Paga directamente con tu móvil en locales asociados.</span>
                                </li>
                            </ul>
                        </div>
                        <motion.div
