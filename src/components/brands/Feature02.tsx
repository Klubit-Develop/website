...
import feauture02 from '../../assets/images/brands/feauture02.png';
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 lg:gap-8 items-stretch">
                        ...
                        <div className="lg:col-span-5" style={{
                            ...
                            <h2 className="mb-6" style={{
                                ...
                                Mide el retorno real de tus activaciones
                            </h2>
                            <p className="mb-5" style={{
                                ...
                                Di adiós a la incertidumbre. Con Klubit sabes qué funciona y qué no.
                            </p>
                            <ul className="space-y-3" style={{ listStyle: 'none', padding: 0 }}>
                                <li className="flex items-start" style={{
                                    ...
                                    <span>Accede a métricas de consumo y comportamiento de clientes.</span>
                                </li>
                                <li className="flex items-start" style={{
                                    color: '#ECF0F5',
                                    fontFamily: '"Helvetica Now Display"',
                                    ...
                                    <Check style={{ marginRight: '12px', color: '#E5FF88', minWidth: '24px', marginTop: '2px' }} size={24} />
                                    <span>Visualiza conversiones, alcance e impacto de cada acción.</span>
                                </li>
                                <li className="flex items-start" style={{
                                    color: '#ECF0F5',
                                    fontFamily: '"Helvetica Now Display"',
                                    ...
                                    <Check style={{ marginRight: '12px', color: '#E5FF88', minWidth: '24px', marginTop: '2px' }} size={24} />
                                    <span>Justifica el retorno de cada euro invertido con datos claros.</span>
                                </li>
                            </ul>
                        </div>
                    </div>
