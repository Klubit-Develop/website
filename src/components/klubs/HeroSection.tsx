...
import heroBackground from '../../assets/images/klubs/hero-background.jpg';
    ...
    return (
        <section className="relative h-screen flex items-end overflow-hidden">
            ...
            >
                ...
                >
                    Gestiona mejor, aumenta tus ingresos y fideliza a tus clientes
                </motion.h1>
                <motion.p
                ...
                >
                    Con Klubit controlas reservas, entradas y consumiciones desde una sola plataforma, potenciada con IA para hacer tu trabajo más fácil.
                </motion.p>
                <motion.button
